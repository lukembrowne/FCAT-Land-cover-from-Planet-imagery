---
title: "Monitoring local scale deforestation in western Ecuador 2019-2022: A case
  study of the FCAT Reserve and surrounding areas"
author: ""
date: "2023-05-01"
output:
  word_document:
...
# Load relevant shapefiles
  bilsa <- terra::vect("../../../FCAT GIS Databases/FCAT_GIS - Boundaries, Roads, Rivers, Trails - 2023_01_19.gpkg",
                       layer = "Reserve Boundary - Bilsa")
  bilsa <- project(bilsa, ras2019)
  
  MCR <- terra::vect("../../../FCAT GIS Databases/FCAT_GIS - Boundaries, Roads, Rivers, Trails - 2023_01_19.gpkg",
                       layer = "Reserve Boundary - REMACH")
  MCR <- project(MCR, ras2019)

  fcat <- terra::vect("../../../FCAT GIS Databases/FCAT_GIS - Boundaries, Roads, Rivers, Trails - 2023_01_19.gpkg",
                       layer = "FCAT - Reserve Boundary 2023_01_19")
  fcat <- project(fcat, ras2019)
  
  laguna <- terra::vect("../../../FCAT GIS Databases/FCAT_GIS - Boundaries, Roads, Rivers, Trails - 2023_01_19.gpkg",
...
change <- terra::rast("./output/change analysis 2023-05-02/forest change sieve 100 2019-2022 - 2023-05-02.tif")
...
cover_stats_MCR <- tibble(year = 2019,
                             MCR = "yes",
                             class = terra::extract(cover2019_focal, MCR_in_focal_zone, ID = FALSE)$lyr1)

cover_stats_MCR <- bind_rows(cover_stats_MCR, 
                          tibble(year = 2019,
                             MCR = "no",
                             class = terra::extract(cover2019_focal, MCR_out_focal_zone, ID = FALSE)$lyr1))

cover_stats_MCR <- bind_rows(cover_stats_MCR, 
                          tibble(year = 2022,
                             MCR = "yes",
                             class = terra::extract(cover2022_focal, MCR_in_focal_zone, ID = FALSE)$class))


cover_stats_MCR <- bind_rows(cover_stats_MCR, 
                          tibble(year = 2022,
                             MCR = "no",
                             class = terra::extract(cover2022_focal, MCR_out_focal_zone, ID = FALSE)$class))
...
cover_stats_fcat <- tibble(year = 2019,
                             fcat = "yes",
                             class = terra::extract(cover2019_focal, fcat_in_focal_zone, ID = FALSE)$lyr1)

cover_stats_fcat <- bind_rows(cover_stats_fcat, 
                          tibble(year = 2019,
                             fcat = "no",
                             class = terra::extract(cover2019_focal, fcat_out_focal_zone, ID = FALSE)$lyr1))

cover_stats_fcat <- bind_rows(cover_stats_fcat, 
                          tibble(year = 2022,
                             fcat = "yes",
                             class = terra::extract(cover2022_focal, fcat_in_focal_zone, ID = FALSE)$class))


cover_stats_fcat <- bind_rows(cover_stats_fcat, 
                          tibble(year = 2022,
                             fcat = "no",
                             class = terra::extract(cover2022_focal, fcat_out_focal_zone, ID = FALSE)$class))
...
gfw <- terra::rast("../../../Satellite imagery/GFW Deforestation alerts/10N_080W_cropped.tif")
